...
{Hardware\\ CPU}
\input{chapter/RevisiCPU.tex}

\chapter[RAM]
{Hardware\\ RAM}
\input{chapter/RAM.tex}
...
\chapter[Modem]
{Hardware\\ modem}
\input{chapter/modem56k.tex}

%\chapter[Wireless Fidelity]
%{Hardware\\ WiFi}
%\input{chapter/wifi.tex}

\chapter[Fiber Optic]
{Hardware\\ Fiber Optic}
\input{chapter/fiberoptic.tex}


\chapter[Coaxial]
{Hardware\\ Coaxial}
\input{chapter/coaxial.tex}
...
%\input{chapter/perkalian.tex}

\chapter[Sensor Gas]
{Sensor Gas\\ Sensor Gas}
\input{chapter/SensorGas.tex}

\chapter[Pembagian Biner]
{Operasi Bilangan\\ Pembagian Biner}
\input{chapter/OperasiPembagian.tex}

\chapter[Jenis Jenis Arduino]
{Operasi Bilangan\\ Pembagian Biner}
\input{chapter/JenisJenisArduino.tex}

\chapter[Cara Koneksi Sensor PIR]
{Cara Koneksi Sensor PIR\\ Cara Koneksi Sensor PIR}
\input{chapter/carakoneksisensorpir.tex}

\chapter[Testing Kode Program]
{Testing Kode Program\\ Cara Koneksi Sensor PIR}
\input{chapter/testingkodeprogram.tex}

\chapter[Sensor Suara]
{Sensor Suara\\ sensor suara}
\input{chapter/sensor_suara.tex}

\chapter[Sensor Ultrasonik]
{Sensor\\ Ultrasonik}
\input{chapter/ultrasonic.tex}

\chapter[Instalasi IDE]
{Instalasi IDE\\ Instalasi IDE}
\input{chapter/instalasiide.tex}

\chapter[Serial To USB]
{Instalasi\\ Serial To USB}
\input{chapter/serialtousb.tex}

\bibliographystyle{IEEEtran}
\bibliography{IEEEabrv,windows,linux,mac,bsd,android,dosunix,software,definisi,kernel,hardware,fiberoptic,coaxial,references}
