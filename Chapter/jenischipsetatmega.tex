...
Atmel's ATmega103 (L) menawarkan memori 128K byte Flash Sistem yang dapat diprogram ulang
dan memori data EEPROM 4K byte.
ATmega103 (L) dikirim dengan Program Flash On-chip dan Data EEPROM
susunan memori dalam keadaan terhapus (mis., isi = $ FF) dan siap diprogram.
Perangkat ini mendukung mode Pemrograman Paralel dan mode Pemrograman Serial.
