...
\ref{hardware.png}
\begin{figure}[ht]
\centerline{\includegraphics[width=1\texwidth]{figures/hardware.png}}
\caption{gambar hardware.}
\label{hardware.png}
\end{figure}

Contoh gambar \ref{hardware.png}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=1\texwidth]{figures/diskdrive.jpg}}
\caption{gambar diskdrive.}
\label{diskdrive.jpg}
\end{figure}

Contoh gambar \ref{diskdrive.jpg}


\begin{figure}[ht]
\centerline{\includegraphics[width=1\texwidth]{figures/monitor.jpg}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=1\texwidth]{figures/m100-gallery.png}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=1\texwidth]{figures/41skLxWQtyL.jpg}}
