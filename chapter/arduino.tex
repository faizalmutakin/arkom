...
\begin{figure}[ht]
  \centerline{\includegraphics[width=.75\textwidth]{figures/hal awal install.png}}
  \caption{Ini adalah halaman awal penginstallan vbb}
  \label{fig:hal awal install}
  \end{figure}
    c. lalu pilih next, seperti pada gambar;
\begin{figure}[ht]
  \centerline{\includegraphics[width=.75\textwidth]{figures/memilih direktori.png}}
