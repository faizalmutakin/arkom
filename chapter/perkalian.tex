...
\begin{figure}[ht]
	\centerline{\includegrapichs[width=1\textwidth]{figures/perkalianbiner.JPEG}}
...
Citra Binary ialah citra yang memiliki 2(dua) nilai : meskipun di zaman ini citra yang memiliki warna lebih disukai, karena memberikan kenangan yang lebih 
banyak dari pada citra biner, tetapi tidak membuat citra biner mati. Pada beberapa aplikasi citra biner masih tetap dibutuhkan, misalnya citra logo instansi (yang
hanya terdiri oleh warna hitam dan putih), citra kode batang  yang tertulis pada label barang, citra hasil pemindahan dokumen teks, dan sebagainya.
...
obyek. Ada dua pendekatan yang digunakan dalam segmentasi objek:
    ...
    \item Segmentasi berdasarkan batas wilayah (tepidariobjek). Pixel - pixel di pinggir di telusuri sehingga rangkaian pixel yang menjadi pembatas     antara 
	obyek dengan latar belakang dapat di lihat secara keseluruhan (algoritma boundary following).
