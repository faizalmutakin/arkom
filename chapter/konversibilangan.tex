ï»¿%Ingat, jangan lupa backup file konversibilangan.tex lalu Git Pull dulu baru ubah file baru Push (Menghindari konflik karena push bersamaan)
...
\\ Setelah angka  9 , kemudian angka yang selanjutnya adalah angka 10, 11, 12 dan sebagainya . Bilangan desimal sering disebut sebagai bilangan berdasar angka 10. Contohnya seperti penulisan pada bilangan desimal : 1710 . Kita juga harus mengingat bahwa desimal berdasar 10 , maka angka 10-lah yang menjadi subscript pada penulisan bilangan decimal .
...
Seprti halnya biner dan oktal,kita pun akan menggunakan teknik perhitungan yang sama.
\\
Langkah-langkah:
begin{enumerate}
...
\subsubsection{Cara mengubah persen,pecahan,dan desimal}
Mengubah bilangan antara persen, pecahan  dan desimal merupakan keterampilan matematika yang penting ada pun cara mengubahnya ada  beberpa cara
\begin{itemize}
\item untuk mengubah persen menjadi desimal
\item mengubah persen menjadi sebagai pecahan
\item hilanglah tanda persen
\end{itemize}
\subsubsection{mengubah persen ke desimal}
    Pindah kan tanda desimal dua tempat kiri.kecuali tertulis sebaliknya, dalam persen, tanda desimal terdapat di ujun angka akhir.sebagia contoh, bayangkan 75% sebenarnya tampak sebagai 75,0%, memindahkan tanda desimal dua tempat ke kiri mengubah persen menjadi desimal. Cara tersebut sama halnya dengan membagi bilngan dengan 100. 
\\Contoh :
\begin{itemize}
\item 7,5% di ubah menjadi 0,75
\item 3,1% di ubah menjadi 0,0031
\item 0,5% di ubah menjadi  0,005
\end{itemize}
\subsubsection{mengubah persen menjadi pecahan}
Menuliskan sebuah bilangann sebagai pecahan 100 adalah cara sederhana lain untuk  menulis persen. Angka dari persen menjadi menjadi pembilng dari pecahan tersebut,sedangkan 100 menjadi penyebutnya. Sederhana pecahan ke berikut nya yang kecil.
\begin{itemize}
\item 36% erubah menjadi 35/100
\item Untuk mudahnya,carilah angka tertinggi yang masuk ke dalam bilangan 36 dan 100. Dalam kasus ini, angka tersebut 4
\item Tentukan berapa kali 4 masuk kedalam bilangan 36 dan 100. 
\end{itemize}
\subsection{Konversi bilngan desimal ke heksadesimal}
...
\begin{itemize}
>>>>>>> f668e134b1ef674ccc60972c9e43e30260656026
\section{Bilangan Desimal} Salwaa Tania (26-10-2017)
Bilangan desimal adalah bilangan yang menggunakan 10 angka mulai 0 sampai 9 berturut-turut. Setelah angka 9 , maka angka berikutnya adalah 10,11,12 dan seterusnya. Bilangan desimal disebut juga dengan bilangan berbasis 10.
\\Contoh: 1710
\\Berikut bagaimana cara melakukan konversi antar basis bilangan: 
